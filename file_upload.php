<?php
   function fileUpload($picture){
       ...
       if($picture["error"] == 4){ // checking if a file has been selected, it will return 0 if you choose a file, and 4 if you didn't
           ...
           $message = $checkIfImage ? "Picture selected" : "The file is not an image!";
       }

       if($message == "Picture selected"){
           ...
           $destination = "resources/{$pictureName}"; // where the file will be saved
